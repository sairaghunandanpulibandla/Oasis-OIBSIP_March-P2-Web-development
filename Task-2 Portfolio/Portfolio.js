...
function waitAndResponce(inputText) {
    ...
    switch (inputText.toLowerCase()) {
        case "intro":
            setTimeout(() => {
                sendTextMessage("Hello there 👋🏻,<br><br>My name is <span class='bold'><a class='alink'>SaiRaghunandan Pulibandla</a>.</span><br><br>I am a Computer Engineering student at <span class='bold'>SRM University AP 👨🏻‍💻📚</span><br><br>I am eager to hear about potential career opportunities, so I would be pleased to chat about job openings in the engineering sphere.<br><br>Send <span class='bold'>'help'</span> to know more about me.<br>");
            }, 2000);
            break;
        case "help":
        ...
        case "clear":
            ...
            break;
        case "about":
            sendTextMessage("🛠️💻 This portfolio website is built using HTML, CSS and JavaScript from SCRATCH!<br><br>👨🏻‍💻 Designed and Developed by <a class='alink' target='_blank' href='https://www.instagram.com/sairaghunandan_1107/'><span class='bold'>SaiRaghunandan Pulibandla</a> with ❤️</span>");
            break;
        case "contact":
